...
echo -e "${YELLOW}Creating .env.development file in root...${NC}"
...
# Create .env.development file in mobile app directory
echo -e "${YELLOW}Creating .env.development file in mobile app...${NC}"
mkdir -p apps/mobile
...
echo -e "${GREEN}Environment variables have been added to .env.development and apps/mobile/.env.development${NC}"
